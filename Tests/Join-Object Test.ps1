...
$TestData1 = {
    ...
    $null = $DataTable.Rows.Add(3,'C','AAA')
}
. $TestData1
...
. $TestData1
$null = Join-Object -Left $PSCustomObjects -Right $DataTable -LeftJoinProperty ID -RightJoinProperty IDD -LeftProperties @{ID= 'ID' ; Sub = 'Subscription'} -ExcludeRightProperties Junk -Prefix 'R_' -PassThru | Format-Table
$PSCustomObjects
...
. $TestData1
$null = Join-Object -Left $DataTable -Right $PSCustomObjects -LeftJoinProperty IDD -RightJoinProperty ID -LeftProperties @{IDD = 'IDD' ; Name = 'NewName'}-RightProperties  @{ID= 'ID' ; Sub = 'Subscription'} -ExcludeLeftProperties Junk -Suffix '_R' -PassThru | Format-Table
$DataTable
